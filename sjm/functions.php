...
function twentythirteen_setup() {
	...
	//header menu
	register_nav_menu('header', __('Header Menu','twentythirteen'));
	//primary menu
...
function twentythirteen_scripts_styles() {
	...
	wp_register_script('flexslider', get_template_directory_uri().'/js/vendor/jquery.flexslider-min.js', false, '1.0.0');
	wp_enqueue_script('flexslider');
	
	wp_register_script('touchswipe', get_template_directory_uri().'/js/vendor/jquery.touchSwipe.min.js', false, '1.0.0');
	wp_enqueue_script('touchswipe');
	
	wp_register_script('google-maps', 'https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false', false, '1.0.0');
	...
	wp_register_style('styles', get_template_directory_uri().'/css/style.css', false, '1.0.0');
	wp_enqueue_style('styles');
